...
!(function (e) {
    (e.fn.gMap = function (o, a) {
        ...
        return this.each(function () {
            ...
            n.address
                ? a.geocode({ address: n.address }, function (e, a) {
                ...
                ? n.markers[0].address
                    ? a.geocode({ address: n.markers[0].address }, function (e, a) {
            ...
            var s = { scrollwheel: n.scrollwheel, disableDoubleClickZoom: !n.doubleclickzoom, draggable: n.draggable };
            n.controls === !1 ? e.extend(s, { disableDefaultUI: !0 }) : 0 !== n.controls.length && e.extend(s, n.controls, { disableDefaultUI: !0 }), o.setOptions(s);
            var t,
                r,
                ...
                if (
                    (r
                        ? ((c = new google.maps.MarkerImage(r.image)),
                          ...
                          h.setIcon(c),
                          r.shadow &&
                              ((p = new google.maps.MarkerImage(r.shadow)), (p.size = new google.maps.Size(r.shadowsize[0], r.shadowsize[1])), (p.anchor = new google.maps.Point(r.shadowanchor[0], r.shadowanchor[1])), i.setShadow(p)))
